...
// /datum/neural_interface_module/logs/UpdateVision()
...
// // ---------------------------------------------------------------------------
// /datum/neural_interface_module/proc/write_log(text, key="LOG", color="#4ad1fa86", size=12, speed=0)
// 	LAZYINITLIST(logs)
...
// /datum/neural_interface_module/proc/clear_logs()
// 	QDEL_LIST(logs)
// 	logs = list()
// 	return TRUE

// /datum/neural_interface_module/proc/remove_log(index)
...
// /datum/neural_interface_module/proc/cleanup_expired_logs()
...
// /datum/neural_interface_module/proc/get_log_section()
// 	var/write = ""
